  ...
  return (
    ...
    >
      ...
      <div style={styles.bottomRow}>
        {isUpcoming ? (
          <button style={styles.viewBtn} onClick={handleViewTicket}>
            <TicketIcon />
            <span>View Ticket</span>
          </button>
        ) : (
          <button
            style={{ ...styles.buyAgainBtn, opacity: booking ? 0.6 : 1 }}
            onClick={handleBuyAgain}
            disabled={booking}
          >
            {booking ? "Booking…" : "Buy Again"}
          </button>
        )}
      </div>
    </div>
...
const styles = {
  ...
  topRow: { display: "flex", gap: "14px", alignItems: "flex-start" },
  iconBox: {
    width: "52px",
    height: "52px",
    borderRadius: "12px",
  ...
  divider: { borderTop: "1px dashed rgba(255,255,255,0.25)" },
  bottomRow: { display: "flex", justifyContent: "center" },
  viewBtn: {
    display: "flex",
    alignItems: "center",
    gap: "8px",
