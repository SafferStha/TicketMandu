...
const settingsItems = [
  { icon: '👤', label: 'Personal Information', sub: 'Update your profile details' },
  { icon: '🔔', label: 'Notifications', sub: 'Manage your alert preferences' },
  { icon: '💳', label: 'Payment Methods', sub: 'Add or remove payment options' },
  { icon: '📍', label: 'Saved Locations', sub: 'Manage your favourite venues' },
  { icon: '🔒', label: 'Security & Privacy', sub: 'Password and security settings' },
    ...
    <div style={styles.page}>
      ...
      <div style={styles.hero}>
        <div style={styles.heroInner}>
          <div style={styles.avatarCircle}>{user.initials}</div>
          ...
          <div style={styles.statsRow}>
            <div style={styles.stat}>
              <span style={styles.statNum}>{user.eventsCount}</span>
              <span style={styles.statLabel}>Events</span>
            </div>
            <div style={styles.statDivider} />
            <div style={styles.stat}>
              <span style={styles.statNum}>{user.ticketsCount}</span>
              <span style={styles.statLabel}>Tickets</span>
            </div>
            <div style={styles.statDivider} />
            <div style={styles.stat}>
              <span style={styles.statNum}>{user.favoritesCount}</span>
      ...
      <div style={styles.content}>
        <div style={styles.card}>
          ...
          {settingsItems.map((item, i) => (
            <button key={i} style={{ ...styles.settingRow, borderBottom: i < settingsItems.length - 1 ? '1px solid #f0f2f8' : 'none' }}>
